...
const navigation = {
    shop: [
        ...
        { name: "Subcriptions", href: "#" }
    ],
    company: [
        { name: "About", href: "#about" },
        { name: "Our Roastwery", href: "#about" },
        { name: "Careers", href: "#" },
        { name: "Press", href: "#" }
    ],
    support: [
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 sm:pt-24 lg:px-8 lg:pt-32 2xl max-w-400">
                ...
                <div className="mt-16 grid grid-cols-2 gap-8 md:grid-cols-4">
                    <ScrollReveal animation="fadeUp" className="col-span-2 md:col-span-1 space-y-4">
                        ...
                        />
                        <p className="footer-discription justify-self-center text-center md:justify-self-autp md:text-left">
                            Premium coffee beans, roasted to order and shipped fresh. From our
                            roastery to your cup sicne 2012.
                        </p>
