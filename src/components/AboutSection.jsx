...
const values = [
    {
        icon: "🌍",
        title: "Direct Trade Origins",
        description: " We partner directly with small farms in Ethiopia, Columbia, Guatemala, and Indonesia. Every bag is fully traceable to the farm it came from."
    },
    {
        icon: "☕",
        title: "Small-Batch Roasting",
        description: "Our master roaster profiles every bean to unlock its peak flavor. We roast in 25-lb batches for consisitency and freshness you can taste."

    },
    {
        icon: "🚚",
        title: "Roast-To-Order Shipping",
        description: "We don't pre-roast and shelve. Your beans are roasted after you order and shipped within 1-2 buisness days. Free delivery on orders over $50."
    }
];
        ...
        <div className="about-content">
            ...
            <div className="about-story-grid">
                <ScrollReveal animation="fadeLeft" className="about-story-text">
                    ...
                    <p className="about-body lead--light">
                        Every week our roastmaster cups dozens of samples to select only the lots that meet our standards. Wether you prefer a bright, fruity Ethipoian  Yirgacheffe or a deep, chocolaty Colombian Supremo, we roast each bath to order so it arrvies at peak freshness.
                    </p>
                </ScrollReveal>
