    ...
    return (
        <motion.header
            ...
            <div className="mx-auto flex w-full max-w-7x1 items-center justify-between px-4 py-3 md:px-8">
                ...
                {/* Desktop Nav */}
                <nav className="nav-links hidden items-center gap gap-10 md:flex">
                    <a href="#home">Home</a>
                    <a href="#shop">Shop</a>
                ...
                <button
                    ...
                    />
                    <span
                        className={`block h-0.5 w-6 bg-black transition- all duraiton-300 ${menuOpen ? "-translate-y-2-rotate-45" : ""}`}
                    />
                </button>
            </div>
